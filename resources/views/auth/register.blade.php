        ...
        <div class="sm:w-72 md:w-96 lg:w-120 xl:w-1/2 mx-auto flex flex-col items-center">
            ...
            <form action="{{ route('register') }}" method="POST" class="mt-4 md:mt-6 w-full max-w-sm">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="Fname" name="Fname" value="{{ old('Fname') }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md py-3 px-3">
                    @error('Fname')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="Lname" name="Lname" value="{{ old('Lname') }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md py-3 px-3">
                    @error('Lname')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-4">
                    <label for="gsm" class="block text-sm font-medium text-gray-700">Phone Number</label>
                    <input type="text" id="gsm" name="gsm" value="{{ old('gsm') }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md py-3 px-3">
                    @error('gsm')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-4">
                    ...
                    <input type="text" id="username" name="username" value="{{ old('username') }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md py-3 px-3">
                    @error('username')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-4 relative">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email') }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md py-3 px-3">
                    @error('email')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div class="mb-4 relative">
                    ...
                    <div class="relative">
                        <input type="password" id="password" name="password" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md py-3 px-3 pr-10">
