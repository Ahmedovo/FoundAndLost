        ...
        <div class="sm:w-72 md:w-96 lg:w-120 xl:w-1/2 mx-auto flex flex-col items-center">
            ...
            <form action="{{ route('login') }}" method="POST" class="mt-4 md:mt-6 w-full max-w-sm">
                ...
                <div class="mb-4 relative">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email') }}" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md dark:bg-gray-800 dark:text-black py-3 px-3">
                    @error('email')
                ...
                <div class="mb-4 relative">
                    ...
                    <div class="relative">
                        <input type="password" id="password" name="password" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md dark:bg-gray-800 dark:text-black py-3 px-3 pr-10">
