        ...
        <div class="home-container w-full md:w-3/4 lg:w-3/5 xl:w-2/3 p-4 md:p-14">
            <div class="home-posts m-4 md:m-10">
                ...
                <ul class="flex flex-col flex-1 gap-4 md:gap-9 w-full" id="posts-list">
                    ...
                    <li class="post p-4 rounded-lg shadow-md mb-6 hidden" 
                        data-author="{{ $post->author->Fname }}" 
                        data-caption="{{ $post->caption }}"
                        data-location="{{ $post->location }}"
                        data-categorie="{{ $post->categorie }}">
                        <div class="flex items-center mb-2 md:mb-4">
                            <div class="flex-shrink-0 w-10 h-10">
                                <img src="{{ asset('storage/users/' . $post->author->image) }}" alt="User Image" class="w-full h-full object-cover rounded-full">
                            </div>
                            <div class="ml-3">
                        ...
                        <div class="post-actions mt-3 md:mt-4 flex justify-between">
                            ...
                            <button class="text-blue-500">Contact</button>
