        ...
        <div class="content-container flex flex-1 flex-col md:flex-row">
                ...
                <center>
                    <form action="{{ route('user.update') }}" method="POST" class="w-full max-w-lg flex flex-col items-center mb-6" enctype="multipart/form-data">
                        ...
                        <div class="text-center mb-6">
                            <img src="{{ asset('storage/users/' . $data->image) }}" alt="Profile Picture" class="w-32 h-32 rounded-full mx-auto hover:opacity-80 transition duration-300">
                        </div>
                        <div class="text-center mb-6">
            ...
            <div class="w-full md:w-1/3 p-6 flex flex-col items-center mb-6 md:mb-0">
                ...
                <div class="space-y-2 w-full">
                    <a href="posts" class="flex gap-2 items-center p-2 font-bold bg-gray-800 rounded-lg hover:bg-gray-700 transition duration-300">
                        <img src="{{ asset('storage/icons/people.svg') }}" alt="" class='group-hover:invert-white' />
                        <span>Change personal information</span>
                    </a>
                    <a href="{{ route('edit') }}" class="flex gap-2 items-center mb-4 p-2 font-bold bg-gray-800 rounded-lg hover:bg-gray-700 transition duration-300">
                        <img src="{{ asset('storage/icons/people.svg') }}" alt="" class='group-hover:invert-white' />
